...
<footer class="border-t border-gray-200 bg-white">
	<div class="flex flex-col items-center justify-between gap-4 px-6 py-4 sm:flex-row lg:px-8">
		<!-- Left Section -->
		<div class="flex items-center gap-2 text-sm text-gray-600">
			<span>&copy; {currentYear} RTB Rwanda, Dashboard</span>
		...
		<div class="flex items-center gap-6 text-sm">
			...
			<a href="/terms" class="text-gray-500 transition-colors hover:text-gray-700">Terms</a>
		</div>
	</div>
</footer>
