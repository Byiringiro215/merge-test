<script lang='ts'>
    import type { CurriculumFiltersState } from './types.js';
    ...
    interface Props {
        filters: CurriculumFiltersState;
        onFiltersChange: (filters: CurriculumFiltersState) => void;
        onExport?: () => void;
    }
    ...
    function updateFilter<K extends keyof CurriculumFiltersState>(
        key: K,
        value: CurriculumFiltersState[K],
    ) {
