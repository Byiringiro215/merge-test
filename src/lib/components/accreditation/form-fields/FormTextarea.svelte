...
<div class={cn('flex flex-col space-y-3', className)}>
    ...
    <textarea
        ...
        class='w-full resize-none rounded-sm border border-slate-200 p-4 text-[13.5px] text-slate-600 outline-none transition focus:border-[#2069C1] focus:ring-1 focus:ring-[#2069C1]/20 placeholder:text-slate-500/70'
    ></textarea>
