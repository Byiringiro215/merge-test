            ...
            <div class='flex flex-1 flex-col overflow-y-auto bg-white py-14 px-8 md:px-[60px] lg:px-[100px] no-scrollbar'>
                <div class='mx-auto flex w-full max-w-[600px] flex-col'>
                    ...
                    {:else if currentStep === 6}
                        ...
                        <!-- Form Container -->
                        <div class='mb-8 rounded-[20px] border border-slate-100 bg-white p-8 shadow-sm'>
                        ...
                        {#if staffList.length > 0}
                            <div class='mb-8 space-y-3'>
                                {#each staffList as staff}
                                    <div class='flex items-center justify-between rounded-sm border border-slate-100 bg-white p-4 shadow-sm'>
                                        <div class='flex items-center gap-4'>
                    ...
                    {:else if currentStep === 7}
                        ...
                        <div class='space-y-4'>
                            {#each [
                                ...
                                <div class='group overflow-hidden rounded-sm border border-slate-200 bg-white shadow-sm transition-all hover:border-slate-300'>
