...
<div class='fixed inset-0 z-100 flex animate-in items-center justify-center bg-slate-900/90 p-4 transition-all fade-in duration-200'>
    <div class={cn(
        'flex flex-col overflow-hidden rounded-sm bg-white shadow-2xl transition-all duration-300',
                ...
                <div class='flex h-full w-full max-w-3xl flex-col overflow-hidden rounded-sm bg-white shadow-lg'>
                    <div class='flex flex-1 flex-col items-center justify-center gap-6 p-12 text-center'>
                        ...
                        <a
                            href={documentUrl}
                            download={documentName}
                            class='rounded-sm bg-[#2069C1] px-6 py-2.5 text-sm font-medium text-white transition-colors hover:bg-[#0864d6]'
                        >
                    ...
                    <div class='pointer-events-none px-12 pb-12 space-y-4 opacity-20'>
                        ...
                        <div class='h-4 w-full rounded-sm bg-slate-200'></div>
                        <div class='h-4 w-5/6 rounded-sm bg-slate-200'></div>
                        <div class='h-32 w-full rounded-sm bg-slate-100'></div>
                        <div class='h-4 w-2/3 rounded-sm bg-slate-200'></div>
                        <div class='h-4 w-full rounded-sm bg-slate-200'></div>
                    </div>
                </div>
            </div>
